...
const urlsToCache = [
  ...
  '/sheenastudio/admin.html',
  '/sheenastudio/admin-login.html',
  '/sheenastudio/calendar.html',
  '/sheenastudio/setup-wizard.html',
  '/sheenastudio/editar-negocio.html',
  '/sheenastudio/manifest.json',
  '/sheenastudio/icons/icon-72x72.png',
  '/sheenastudio/icons/icon-96x96.png',
  '/sheenastudio/icons/icon-128x128.png',
  '/sheenastudio/icons/icon-144x144.png',
      ...
      .catch(() => {
        ...
        return caches.match(event.request).then(cachedResponse => {
          ...
          if (event.request.url.match(/\.(jpg|jpeg|png|gif|svg|webp)$/)) {
            return caches.match('/sheenastudio/icons/icon-192x192.png');
          }
